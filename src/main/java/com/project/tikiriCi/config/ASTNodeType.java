...
public class ASTNodeType {
    ...
    public static String DIV = TokenType.DIV;
    public static String MOD = TokenType.MOD;
    public static String PLUS = TokenType.PLUS;
    public static String AND = TokenType.AND;
    public static String OR = TokenType.OR;
    public static String EQUAL = TokenType.EQUAL;
    public static String NOTEQUAL = TokenType.NOTEQUAL;
    public static String LESSTHAN  = TokenType.LEFT_CHEVRON;
